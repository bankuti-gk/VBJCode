...
def get_cluster_path():
    cluster_path = filedialog.askdirectory(initialdir="/", title="Válassza ki a cluster mappát..")

root = Tk()
root.title("Cluster Command Center")
root.geometry("800x500")
get_cluster_button = Button(root, text="Cluster Megnyitása", command=get_cluster_path, activebackground="gray").pack(side=TOP)
